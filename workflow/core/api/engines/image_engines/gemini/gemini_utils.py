...
from workflow.core.api.engines.image_engines.gemini import gemini_types
    ...
    def _generate_images(
        ...
        *,
        ...
        if self._client is None:
            self._client = get_default_prediction_client()
        ...
        generated_images: List[gemini_types.GeneratedImage] = []
        for idx, prediction in enumerate(response.predictions):
            ...
            generated_image = gemini_types.GeneratedImage(
...
class ImageGenerationResponse:
    ...
    images: List[gemini_types.GeneratedImage]

    def __iter__(self) -> typing.Iterator[gemini_types.GeneratedImage]:
        """Iterates through the generated images."""
        yield from self.images

    def __getitem__(self, idx: int) -> gemini_types.GeneratedImage:
