...
class TaskResponse(BaseModel):
    ...
    def task_content(self) -> Dict[str, Any]:
        return self.task_outputs.model_dump() if self.task_outputs else {}
...
class MessageDict(TypedDict, total=False):
    ...
    type: Annotated[Optional[Literal[ 'text', 'image', 'video', 'audio', 'file', 'TaskResponse']], Field(default="text", description="Type of the message")]
    ...
    task_responses: Optional[List[Union[str, TaskResponse, DatabaseTaskResponse]]] = Field(default_factory=list, description="List of associated task responses")
