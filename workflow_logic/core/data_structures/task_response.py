...
from workflow_logic.core.data_structures.central_types import ReferencesType
...
class TaskResponse(BaseDataStructure):
    ...
    references: ReferencesType = Field(default_factory=lambda: References(), description="References associated with this task response")
