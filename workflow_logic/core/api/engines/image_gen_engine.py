        ...
        try:
            ...
            for index, image_data in enumerate(response.data):
                ...
                file_references.append(FileContentReference(
                    ...
                    transcript=MessageDict(role='tool', content=f"Image generated by model {model}. /nPrompt: '{prompt}' /nSize: {size}", type=ContentType.TEXT, generated_by='tool', creation_metadata={"prompt": prompt, "size": size, "quality": quality, "model": model})
                ))
